...
This code is made publicly available on GitHub SOLELY for viewing and reference purposes.
No permission is granted to copy, modify, distribute, sublicense, or use this code for any commercial or non-commercial purpose without explicit written authorization from XJTLU.
